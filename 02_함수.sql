...
--MONTHS_BETWEEN(날짜, 날짜) : 두 날짜의 개월 수 차이 변환
...
SELECT TO_DATE('400505','YYMMDD')FROM DUAL;
...
-- EMPOYEE 테이블에서 보너스를 받으면 'O' , 안받으면' X' 조회
...
'J5','10%','5%')인상률
DECODE(JOB_CODE,'J7',SALARY*1.2,'J6',
SALARY*1.15,'J5',SALARY*1.1,SALARY*1.05) "인상된 급여"
FROM EMPLOYEE;
...
-- COUNT(컬럼명) : NULL을 제외한 실제 값이 기록된 행의 개수 리턴
